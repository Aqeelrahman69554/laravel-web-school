@extends('visitor.index') {{-- Mengambil kerangka dari file main --}}
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mb-5">
                    <p>
                        Labore sea amet kasd diam justo amet ut vero justo.
                        Ipsum ut et kasd duo sit, ipsum sea et erat est
                        dolore, magna ipsum et magna elitr. Accusam accusam
                        lorem magna, eos et sed eirmod dolor est eirmod
                        eirmod amet.
                    </p>
                    <div class="d-flex">
